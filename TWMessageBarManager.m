...
+ (void)initialize
{
	if (self == [TWMessageView class])
	{
        ...
        kTWMessageViewDescriptionFont = [UIFont systemFontOfSize:15.0];
...
+ (void)initialize
{
	...
	{
        // Colors (background)
        kTWDefaultMessageBarStyleSheetErrorBackgroundColor = [UIColor colorWithRed:159.0f/255.0f green:7.0f/255.0f blue:7.0f/255.0f alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // orange
