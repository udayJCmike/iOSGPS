...
-(void)layoutSubviews
{
    ...
    [_dayPicker retrieveCustomPickerViewControllerDidSpinCallback:^(int day)
    {
        ...
        [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%d",day]  forKey:@"day"];
    ...
    [_yearPicker retrieveCustomPickerViewControllerDidSpinCallback:^(int year)
    {
        ...
        _year1=_year;
        NSLog(@"Year2 %d",_year);
        [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%d",(int)_year]  forKey:@"year"];
    ...
    [_mounthPicker retrieveCustomPickerViewControllerDidSpinCallback:^(int month)
    {
        ...
        NSLog(@"Month %d",month);
         [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%d",month]  forKey:@"month"];
