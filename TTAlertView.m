...
- (void)setupDefaultInsets
{
    ...
    if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
    {
        ...
        self.containerLeftInset = kTTDefaultDialogLeftInset+100;
...
- (void)layoutInWindow:(UIWindow *)window
{
    ...
    if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
    {
        ...
        // size title label
        CGFloat contentWidth = self.bounds.size.width-100 - self.contentInsets.left - self.contentInsets.right - self.containerLeftInset - self.containerRightInset;
        ...
        CGFloat totalButtonWidth = self.bounds.size.width-100 - self.containerLeftInset - self.containerRightInset - self.buttonInsets.left - self.buttonInsets.right;
        ...
        [self.containerView setFrame:(CGRect){ { self.containerLeftInset, MAX(self.containerMinVerticalInset, self.frame.size.height/2 - dialogHeight/2) + self.containerVerticalOffset }, { self.bounds.size.width-100 - self.containerLeftInset - self.containerRightInset, dialogHeight } }];
    }
    else if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone) {
